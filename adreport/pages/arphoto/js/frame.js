var hostPath        = "https://dt-static.syrup.co.kr/danjong/";
...
var modelList = [
    {
        id : '단이',
        src : hostPath + "/models/King_V4.gltf",
        thumbnail : hostPath + "/img/model/King_V3.png",
        position : "1 1 -10",
        rotation : "0 0 0",
        scale : 1,
    },
    {
        id : '정이',
        src : hostPath + "/models/Queen_V3.gltf",
        thumbnail : hostPath + "/img/model/Queen_V2.png",
        position : "1 1 -10",
        rotation : "0 0 0",
        scale : 1,
    },
    {
        id : '단정이',
        src : hostPath + "/models/Kings_V1.gltf",
        thumbnail : hostPath + "/img/model/Kings_V1.png",
        position : "1 1 -10",
        rotation : "0 0 0",
        scale : 1,
    },
...
function InitSkinData()
{
    ...
    for (let i = 0; i < skinIdList.length; i++) {
        ...
        let imgName = 'skin_' + (i+1).toString().padStart(2, '0');

        pushSkinData(skinIdList[i], imgName + '.png', imgName + 't.png' );
...
function initEvent(){
    ...
    qs("#btn-print").addEventListener("click", function(){
        ...
        var url     = window.location.href;
        var link    = url.slice(0,url.lastIndexOf("/")) + "/print/print_1.html";
        window.open(link);
    });
