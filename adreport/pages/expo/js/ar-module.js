...
AFRAME.registerComponent("main-scene", {
  ...
  resetCamera: function() {
    var resolutionInfo = cameraResolutionDict[this.selectedRatio];
  ...
  capture: function() {    
    ...
    html2canvas(document.querySelector('body'), {
      ...
      // 현재 카메라 해상도 가져오기
      let resolutionInfo = cameraResolutionDict[this.selectedRatio];
  ...
  // 모델 데이터 추가
  addModel(key, src, position, rotation, scale){
