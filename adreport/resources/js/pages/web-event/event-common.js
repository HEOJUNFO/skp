...
( function( $, window, document, undefined ) {
    ...
    const _smsPopup = function(smsMenuType, eventType) {
        ...
        if (smsMenuType === _smsMenuType.MAIN_ATTEND) {
            ...
            if (eventType === _eventType.AR || eventType === _eventType.PHOTO) {
     ...
     *  TOKEN > "{"partnerToken":"토큰명","partnerTokenCreatedDate":"2023-06-30 10:47:34"}"
     */
        ...
        if (type) {
            switch (type) {
                ...
                case "EVENT_ID" : localStorageInfo = $.jStorage.get("eventId");
                    break;
                case "TOKEN" : localStorageInfo = $.jStorage.get("partnerTokenInfo");
                    break;
                default:
                    break;
            }
     ...
     */
    const _getNowDateTime = function() {
    ...
    is.getNowDateTime = _getNowDateTime;
