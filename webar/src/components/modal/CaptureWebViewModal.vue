<template>
  <vue-final-modal v-model="showVModal">
    <div class="main-content" :style="{ backgroundImage: `url(${filmResultImgUrl})` }">
      ...
      <button v-if="photoGiveAwayYn && !isDecorate" class="box-button" @click="openCompletePopup('')">{{ photoGiveAwayButtonText }}</button>
...
export default {
  ...
  setup() {
    ...
    const { putLogPersonAgree } = useLogPersonAgree();
